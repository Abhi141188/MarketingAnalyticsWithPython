...
#divmod(): Used to get remainder and quotient of two numbers. 
...
#enumerate(): Returns an enumerated object. It takes two parameters, 
#first is a sequence of elements and the second is the start index of the sequence.
# Calling function  
